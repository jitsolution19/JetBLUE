...
import common_function.City_Selection;

public class Domestic_Booking_RoundTrip extends navigation{
	
	City_Selection obj = new City_Selection();
//	WebDriver driver;
//	@BeforeClass
//	public void RoundTrip_Setup()
//	{
//		obj.Application_Launch();
//		driver = obj.driver;
//	
//	}
	@Test
	public void RoundTrip()
	{
		...
		while (timing_count.hasNext())
		{
			...
			if(Dep_timing.getText().matches("6:59 AM"))
			{
				...
				List<WebElement> exactPrice = temp.findElements(By.xpath("//following-sibling::td//div[@class='colPrice']/label"));
